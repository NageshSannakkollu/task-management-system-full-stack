 ...
 const[searchInput,setSearchInput] = useState('')
  ...
  useEffect(() => {
    ...
    const getTaskData = async() => {
      const response = await fetch("https://task-management-system-nodejs.netlify.app/api/tasks");
  ...
  const clickOnDelete = (id) => {
    ...
    axios.delete(`https://task-management-system-nodejs.netlify.app/api/tasks/${id}`)
    .then(response => {
